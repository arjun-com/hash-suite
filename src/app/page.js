	...
	return (
		<>
			...
			<div className = "text-center absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10">
				...
				<Link href = "/hashes/MD5" className = { `${inter.className} w-max align-top text-xl rounded-md px-6 py-2 bg-neutral-100 text-neutral-800 font-light group transition-all text-nowrap hover:ring-2 ring-blue-500 ring-offset-2` }>HashSuite has got your back. </Link>
			</div>
